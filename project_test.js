...
7 | 8 | 9
*/
let sampleboard = console.log("1 | 2 | 3\n---------\n4 | 5 | 6\n---------\n7 | 8 | 9");
...
let h;
let i;
function printBoard(mark) {
board[0] === mark ? a = mark : a = 1;
board[1] === mark ? a = mark : a = 2;
board[2] === mark ? a = mark : a = 3;
board[3] === mark ? a = mark : a = 4;
board[4] === mark ? a = mark : a = 5;
board[5] === mark ? a = mark : a = 6;
board[6] === mark ? a = mark : a = 7;
board[7] === mark ? a = mark : a = 8;
board[8] === mark ? a = mark : a = 9;
...
if (Number(position) < 1 || Number(position) > 9){
    ...
    valid = false;
}else if (board[Number(position)] === ' '){
    valid = true;
}else if (position === ' '){
    console.log('invalid input!');
    valid = false;
}else {
    console.log('Please only enter a number from 1 - 9');
    valid = false;
}return valid;
}
